...
$(document).ready(function () {
    ...
    $("#search-friends").on("keyup", function () {
        ...
        $(".header-client-list .userlist-box .media-body .chat-header").each(function () {
    ...
    $(".displayChatbox").on("click", function () {
        $(".header-client-list").toggleClass("open")
    });
    $(".header-client-list .userlist-box").on("click", function () {
        $(".header-chat").addClass("open");
        $(".header-client-list").toggleClass("msg-open")
    });
    $(".h-back-client-list").on("click", function () {
        $(".header-chat").removeClass("open");
        $(".header-client-list").removeClass("msg-open")
    });
    $(".h-close-text").on("click", function () {
        $(".header-chat").removeClass("open");
        $(".header-client-list").removeClass("open");
        $(".header-client-list").removeClass("msg-open")
    });
